            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return _buildHistoryCard(context, entry, historyProvider);
                },
              ),
            ),
          ],
  ...
  void _showClearDialog(BuildContext context, HistoryProvider provider) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'This will permanently delete all your saved questions and answers. This action cannot be undone.',
        ),
        actions: [
          TextButton(
